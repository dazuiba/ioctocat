...
//	} else if ([entry.eventItem isKindOfClass:[GHBroadcast class]]) {
//		[tbItems addObject:repositoryItem];
...
//	GHRepository *repository = [item isKindOfClass:[GHBroadcast class]] ? [(GHBroadcast *)item repository] : item; 
...
//	GHBroadcast *issue = entry.eventItem;
